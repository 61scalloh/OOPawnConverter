...
public oo_init()
{
	new Class:_c_PlayerClass = oo_class("PlayerClass")
	{
		...
		oo_method(_c_PlayerClass, MT_CTOR, "Ctor", FP_CELL, FP_FLOAT, FP_STRING, FP_VAL_BYREF)
		oo_method(_c_PlayerClass, MT_DTOR, "Dtor")
		oo_method(_c_PlayerClass, MT_METHOD, "Assign", FP_FLOAT, FP_CELL);
	}
	...
	new Class:_c_Human = oo_class("Human", "PlayerClass")
	{
		...
		oo_method(_c_Human, MT_CTOR, "Ctor", FP_STRING, FP_ARRAY, FP_ARRAY)
		oo_method(_c_Human, MT_DTOR, "Dtor")
		oo_method(_c_Human, MT_METHOD, "JoeBao")
	}
}

public Object:PlayerClass@Assign(Float:f, Object:i)
{

}
public PlayerClass@Ctor(Object:i, const Float:f, const s[], arr[32] &cell)
{
	new fuck = 999;
}
